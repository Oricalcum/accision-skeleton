...
/**
 * <p>
 * <code>QualityManagementReportAdminEditProcessView</code> is the presentation layer
 ...
 */
public class QualityManagementReportAdminEditProcessView extends AbstractProcessView {
   ...
   */
  public QualityManagementReportAdminEditProcessView(PortalBean portalBean, PortalPageContext portalPageContext) {
  ...
  public void pageStart() {
    ...
    AccisionLogger.debug(QualityManagementReportAdminEditProcessView.class, "pageStart()", "task=" + task);
    ...
    if (save) {
      ...
      AccisionLogger.debug(QualityManagementReportAdminEditProcessView.class, "pageStart()", "showStackTrace=" + showStackTrace);
  ...
  public void serviceHTML() {
    try {
      ...
      AccisionLogger.error(QualityManagementReportAdminEditProcessView.class, "serviceHTML()", message, e);
