...
/**
 * <p>
 * <code>@adminViewName</code> is the presentation layer
 ...
 */
public class @adminViewName extends JSPView {
  /**
   * Constructor
   *
   ...
   */
  public @adminViewName(PortalBean portalBean, PortalPageContext portalPageContext, String jspFileName) {
    super(portalBean, portalPageContext, jspFileName);

    @beanName @varBeanName = (@beanName)portalBean;

    try {
      @varBeanName.setAdminReferenceData(portalPageContext, this);
   ...
   * @return the form
   */
  public @adminFormName getForm() {
    return ((@beanName)getBean()).getAdminForm(this);
  }
}
